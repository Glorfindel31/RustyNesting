 ...
 */
export function createHtmlElement(tagName) {
 ...
 */
export function getDataAttribute(element, dataKey) {
 ...
 */
export function setDataAttribute(element, dataKey, value) {
 ...
 */
export function cloneSvgElementDeep(element) {
 ...
 */
export function createTranslate(x, y) {
 ...
 */
export function createCssTransform(x, y, rotation) {
