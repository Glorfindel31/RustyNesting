 ...
 */
export function getScaleInUnits(scale, units) {
    if (units === "mm") {
 ...
 */
export function setScaleFromUnits(value, units) {
    if (units === "mm") {
 ...
 */
export function getConversionFactor(scale, units) {
    if (units === "mm") {
        return scale / INCHES_TO_MM;
    }
    return scale;
 ...
 */
export function toSvgUnits(value, scale, units) {
 ...
 */
export function fromSvgUnits(value, scale, units) {
    const conversion = getConversionFactor(scale, units);
    return value / conversion;
}
/**
 ...
 */
export function formatDimension(value, scale, units, precision = 1) {
 ...
 */
export function formatBounds(width, height, scale, units, precision = 1) {
 ...
 */
export function getUnitSuffix(units) {
 ...
 */
export function getExportScale(scale, units, dxfExportScale) {
 ...
 */
export function toExportDimension(svgValue, scale, units, dxfExportScale) {
 ...
 */
export function toInches(svgLength, scale) {
 ...
 */
export function fromInches(inches, scale) {
    return inches * scale;
}
