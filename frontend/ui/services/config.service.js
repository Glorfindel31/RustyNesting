...
export class ConfigService {
    ...
    constructor(ipcRenderer) {
        ...
        this.dominantPartAreaThreshold = this.config.dominantPartAreaThreshold;
    }
    /**
    ...
    async initialize() {
        ...
        if (this.ipcRenderer) {
            try {
                const savedConfig = (await this.ipcRenderer.invoke(IPC_CHANNELS.READ_CONFIG));
     ...
     */
    static isBooleanKey(key) {
        return BOOLEAN_CONFIG_KEYS.includes(key);
    }
    /**
     ...
     */
    setScaleFromUnits(scaleInUnits) {
     ...
     */
    static async create(ipcRenderer) {
 ...
 */
export async function createConfigService(ipcRenderer) {
 ...
 */
export function isValidUnitType(value) {
