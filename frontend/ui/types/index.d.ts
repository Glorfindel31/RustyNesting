 ...
 */
export type { DeepNestConfig, SheetPlacement, NestingResult, PlacementType, UnitType, Bounds, PolygonPoint, Polygon, Part, } from "../../../index.d.ts";
 ...
 */
export declare const DEFAULT_CONVERSION_SERVER = "https://converter.deepnest.app/convert";
/**
...
/**
 * Log entry relayed from a background worker (or a crashed worker)
 */
export interface BackgroundLogPayload {
    level: "error" | "warn" | "info";
    /** Worker index, or -1 for a whole-window crash */
    index: number;
    message: string;
}
/**
...
export interface DeepNestInstance {
     ...
     */
    importsvg(filename: string | null, dirpath: string | null, svgstring: string, scalingFactor?: number | null, dxfFlag?: boolean): Part[];
    /**
    ...
    /**
     * Parts whose bounding box doesn't fit within any defined sheet, in either
     * orientation (bounding-box check only, not a full polygon NFP fit)
     * @returns The oversized part objects (from `parts`), for selecting/highlighting in the UI
     */
    getOversizedParts(): Part[];
    /**
     ...
     */
    start(progressCallback: ((progress: NestingProgress) => void) | null, displayCallback: (() => void) | null): void;
    /**
...
export declare const IPC_CHANNELS: {
    readonly LOAD_PRESETS: "load-presets";
    readonly SAVE_PRESET: "save-preset";
    readonly DELETE_PRESET: "delete-preset";
    readonly READ_CONFIG: "read-config";
    readonly WRITE_CONFIG: "write-config";
    readonly BACKGROUND_START: "background-start";
    readonly BACKGROUND_STOP: "background-stop";
    readonly BACKGROUND_PROGRESS: "background-progress";
    readonly BACKGROUND_RESPONSE: "background-response";
    readonly BACKGROUND_LOG: "background-log";
    readonly SET_PLACEMENTS: "setPlacements";
};
/**
...
export interface SvgParserInstance {
    ...
    transformParse(transformString: string): {
        calc(point: PolygonPoint): PolygonPoint;
    } | null;
