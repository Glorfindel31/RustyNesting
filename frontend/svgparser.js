...
export class SvgParser {
	...
	polygonify(element){
      ...
      case 'circle':
				...
				// tag with exact circle metadata so downstream NFP calculation can use
				// closed-form math (disk offset) instead of tessellated polygon ops
				poly.isCircle = { cx: cx, cy: cy, r: radius };
			break;
			case 'ellipse':
